...
<body>
    ...
    <div class="form-container">
        ...
        <form id="lost-item-form" action="http://localhost/pikachu/Nayan/lost_item.php" method="post" enctype="multipart/form-data">
    ...
    <script>
        ...
        // JavaScript to set the max attribute dynamically to today's date
